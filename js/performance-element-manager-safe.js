...
class SafePerformanceElementManager {
    constructor() {
    ...
    // Destroy the manager
    destroy() {
        console.log('🧹 Destroying SafePerformanceElementManager...');
        
        this.stopMonitoring();
        this.reset();
        
        console.log('✅ SafePerformanceElementManager destroyed');
    }
}

export default SafePerformanceElementManager;